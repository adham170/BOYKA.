...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./BOYKA1.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/adham170/BOYKA1/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1665690764,1665690764,1463960994}   
...
if tonumber(user_id) == tonumber(1665690764) then  
var = true  
elseif tonumber(user_id) == tonumber(1665690764) then
var = true 
...
local UserName = (data.username_ or "SOURCE42")
...
os.execute('rm -rf BOYKA1.lua')
os.execute('wget https://raw.githubusercontent.com/adham170/BOYKA1/master/BOYKA1.lua')
send(msg.chat_id_, msg.id_,'➢ تم تحديث السورس \n➢ لديك اخر اصدار لسورس مادو\n➢ الاصدار » { 1v}')
dofile('BOYKA1.lua')  
end
if text == 'الاصدار' and DevBOYKAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'➢ اصدار سورس مادو \n➢ الاصدار »{ 1v}')
end
...
usertext = '\n➢ العضو » ['..result.title_..'](t.me/'..(username or 'SOURCE42')..')'
status  = '\n➢ تم ترقيته مطور'
...
usertext = '\n➢ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE42')..')'
status  = '\n➢ تم ترقيته مطور'
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'➢ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCE42')..') \n➢ '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"➢ العضو : {["..data.first_name_.."](T.ME/SOURCE42)}\n➢ ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "➢ عذرا » {["..data.first_name_.."](T.ME/SOURCE42)}\n➢ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'➢ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCE42')..') \n➢ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'➢ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SOURCE42')..') \n➢ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1665690764) then  
...
if tonumber(result.id_) == tonumber(1665690764) then  
send(msg.chat_id_, msg.id_, "➢ لا تستطيع حظر او كتم او طرد مطور السورس")
return false 
end
...
if tonumber(userid) == tonumber(1665690764) then  
send(msg.chat_id_, msg.id_, "➢ لا تستطيع كتم او حظر او تقييد مطور السورس")
return false 
end
if tonumber(userid) == tonumber(1665690764) then  
...
if DevBOYKAW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/adham170/BOYKA1/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n➢ اهلا بك في متجر ملفات مادو\n➢ ملفات السورس ↓\n 𓇠 ⟼⟼⟼𝗠𝗔𝗥𝗩𝗘𝗟𝗟 𖠱²²⟻⟻⟻•\n\n"
local TextE = "\n 𓇠 ⟼⟼⟼𝗠𝗔𝗥𝗩𝗘𝗟𝗟 𖠱²²⟻⟻⟻•\n➢ علامة تعني { ✓ } ملف مفعل\n➢ علامة تعني { ✘ } ملف معطل\n➢ قناة سورس مادو ↓\n".."➢ [اضغط هنا لدخول](t.me/SOURCE42) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/adham170/BOYKA1/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BOYKA1.lua')  
else
send(msg.chat_id_, msg.id_,"➢ عذرا الملف لايدعم سورس مادو \n") 
end
return false
end
...
local UserName = (b.username_ or "SOURCE42")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n➢ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE42')..')'
status  = '\n➢ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n➢ العضو » '..userid..''
...
if text == 'مادو' then 
send(msg.chat_id_,msg.id_, '[مطور السورس.](http://t.me/UU_BAN) ') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n➢ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE42')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n➢ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'SOURCE42')..')'..'\n➢ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'مادو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'مادو')
local BOYKA_Msg = {
'اؤمرني 🥺💕.',
'ليا اسم خد بالك ☹️.',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'مادو').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE42')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_, msg.id_, t..'ٴ➢  𓇠 ⟼⟼⟼𝗠𝗔𝗥𝗩𝗘𝗟𝗟 𖠱²²⟻⟻⟻•➢○ٴ\n➢ 彡 .[𝘉𝘖𝘠𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/SOURCE42)➢ ')
end
...
------------------------------------------------------------------------
local SOURCE42 = database:get(bot_id.."BOYKA1:Add:Filter:Rp2"..text..result.chat_id_)   
if SOURCE42 then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"➢ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n➢ ["..SOURCE42.."] \n") 
